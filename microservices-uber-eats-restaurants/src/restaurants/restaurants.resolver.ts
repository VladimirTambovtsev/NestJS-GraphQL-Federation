...
export class RestaurantsResolver {
  ...
  user(@Parent() restaurant: Restaurant) {
    return { __typename: 'User', id: restaurant.id };
  }
  ...
  // }
  // @ResolveField((of) => User)
  // user(@Parent() restaurant: Restaurant): any {
  //   return { __typename: 'Restaurant', id: restaurant.id };
  // }
}
